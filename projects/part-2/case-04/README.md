...
Запускайте тетрадь из каталога расследования. Начальная ячейка также умеет найти каталог из
корня репозитория. Данные не скачиваются и не требуют предыдущих расследований.
