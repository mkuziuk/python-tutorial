...
Пятый проект учебника: небольшая ООП-система для ведения расследования. Мы храним участников, улики и заметки как объекты, загружаем исходные данные из JSON и сохраняем обновленный снимок дела.
