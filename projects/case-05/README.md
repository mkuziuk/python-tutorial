...
Пятый проект учебника: небольшая ООП-доска для расследования ночного сигнала архива. Мы храним участников, улики и заметки как объекты, загружаем исходные данные из JSON и сохраняем обновленный снимок дела.
