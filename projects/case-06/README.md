...
Стартовый файл намеренно пуст. Готовая версия читает доску I-05 из `data/artifacts/05-case-board.json`, добавляет только новые записи из `data/morning_updates.json` и создаёт `artifacts/06-verdict.json`.
...
- объединение сохранённой доски с новыми утренними материалами.
