...
Финальный проект сводит улики ночи 14 марта 2026 года в проверяемый отчет: хронологию, рейтинг гипотез, ограничения вывода и решение об открытии выставки 15 марта.
...
Стартовый файл пустой. Соберите его по главе «Дело 06. Вердикт перед открытием». Готовая программа читает `data/evidence_bundle.json`, печатает отчет и создает `verdict.json` рядом со скриптом.
