...
Стартовый файл намеренно пуст. По главе вы добавите чтение писем, поиск ссылок и правила риска: срочность, несовпадение `Reply-To`, ссылки на IP-адреса, `http` без шифрования, расхождение видимого домена с фактическим адресом и подозрительные имена вложений.
