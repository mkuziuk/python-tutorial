...
Учебный проект: консольный инструмент, который читает синтетические `.eml`-письма и объясняет, какие признаки риска он нашел.

В папке `data/` шесть вымышленных писем: два похожи на ловушки перед открытием архива, четыре выглядят как обычная рабочая переписка. В них используются только учебные домены и документационные IP-адреса.
