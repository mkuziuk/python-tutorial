...
В стартовом файле есть только учебные ориентиры. По главе вы добавите загрузку материалов, анализ слов и пунктуации, сравнение профилей и таблицу результатов.
