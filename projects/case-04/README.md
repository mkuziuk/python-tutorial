...
Четвертый проект учебника: индексатор папки после ночного сигнала архива. Он собирает JSON-манифест, ищет дубли по SHA-256 и показывает изменения между запусками.
