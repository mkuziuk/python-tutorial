...
В стартовом файле есть только учебные ориентиры. По главе вы добавите обход `data/secret_folder/`, вычисление SHA-256, временные метки, JSON-манифест, поиск дублей, сравнение с прошлым запуском и построчное сравнение двух хронологий через `difflib`.
