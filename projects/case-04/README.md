...
Четвертый проект: индексатор папки после ночного сигнала архива. Он собирает JSON-манифест, ищет дубли по SHA-256, показывает изменения между запусками и сравнивает две версии хронологии.
...
Стартовый файл пустой. В главе вы вручную добавите обход `data/secret_folder/`, SHA-256, timestamps, JSON-манифест, поиск дублей, сравнение с прошлым запуском и построчное сравнение двух хронологий через `difflib`.
