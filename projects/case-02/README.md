...
Стартовый файл намеренно пуст. По главе вы добавите чтение текста, нормализацию слов, n-граммы, сравнение множеств, загрузку результата I-01 и сохранение нового отчёта.
