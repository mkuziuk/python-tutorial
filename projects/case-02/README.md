...
В начале файл только загружает папку с отчетами и показывает список файлов. Дальше глава показывает, как постепенно добавить чтение текста, нормализацию слов, n-граммы, сравнение множеств, сортировку рейтинга и таблицу результатов.
