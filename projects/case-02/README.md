...
В начале файл только подключает `Path`, `Console` и путь к папке `data`. Дальше глава показывает, как вручную добавить чтение текста, нормализацию слов, n-граммы, сравнение множеств, сортировку рейтинга и таблицу результатов.
