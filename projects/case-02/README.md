...
Второй проект учебника: консольный инструмент, который сравнивает архивные фрагменты по n-граммам и поднимает наверх подозрительные совпадения, похожие на утечку или подмену.
