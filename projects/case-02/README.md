...
В начале файл только загружает отчеты и показывает короткую сводку. Дальше глава показывает, как постепенно добавить нормализацию слов, n-граммы, сравнение множеств, сортировку рейтинга и таблицу результатов.
