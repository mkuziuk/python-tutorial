...
description: "Первое дело Бюро: строим базовую модель и k-NN на Iris, отделяя качество на обучении от качества на новых данных."
arc: part-2
caseNumber: II-01
...
```python
# Тестовую выборку откладываем один раз и не используем при выборе модели.
...
Базовая модель отвечает на вопрос «лучше ли модель самого примитивного правила?», поэтому оценивается на той же внешней тестовой выборке:
