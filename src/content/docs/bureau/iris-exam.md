...
<div class="bureau-brief">
  ...
  <p><strong>Данные</strong> встроенный набор Iris: 150 цветков, четыре измерения, три вида.</p>
...
<div class="materials-panel bureau-actions">
  <p><strong>Начать:</strong> <a href="../../downloads/part-2-case-01.zip">скачать ZIP</a> · <a href="https://colab.research.google.com/github/mkuziuk/python-tutorial/blob/main/projects/part-2/case-01/case-01.ipynb">Open in Colab</a></p>
...
1. загрузите Iris в `DataFrame`, изучите форму, столбцы, классы и диаграммы признаков;
...
Ниже — три реперные ячейки из learner notebook, а не готовое решение. Они показывают порядок проверки: сначала заморозить стратифицированный split, затем измерить на нем простейший baseline и только после выбора `k` сравнить модели. Выполняйте их в notebook сверху вниз: переменные из предыдущих ячеек здесь намеренно не повторяются.
