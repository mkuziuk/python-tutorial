...
Финальное расследование тоже начинается с файла. Тетрадь проверяет документированный синтетический CSV.GZ и создаёт `DataFrame` со связанными снимками и служебными полями:
