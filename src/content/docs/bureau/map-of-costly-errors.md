...
<div class="bureau-brief">
  ...
  <p><strong>Данные</strong> замороженный снимок California Housing с локальной карточкой происхождения.</p>
...
В этом деле нужно различить две задачи. Случайная тестовая выборка проверяет интерполяцию среди похожих наблюдений. Географическая тестовая выборка ближе к обещанию переноса в области, которых модель не видела. Один и тот же алгоритм может давать правдивые, но относящиеся к разным вопросам оценки.
