...
- `.get("limitation", "")` оставляет пустую строку, если у новой записи нет отдельного ограничения;
...
Поле `limitation` принципиально важно. Рейтинг I-01 не превращается в доказанное авторство, а признаки I-03 не превращаются в доказанный взлом только потому, что записи попали в финальный отчёт.
