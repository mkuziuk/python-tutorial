...
Это сильная связь, но не безусловное доказательство. Аудит устанавливает происхождение действий учётной записи, а не мотив. Он не заменяет видеозапись человека за клавиатурой и полное интервью.
...
Рейтинг ещё не является решением. Добавьте сборку и сохранение JSON-отчёта. Основная гипотеза намеренно названа «самой сильной рабочей гипотезой», а рядом сохраняется ограничение вывода.
...
Открытие нужно **отложить**. Это не наказание и не объявление виновного. Целостность описи и рабочей хронологии нарушена, а доступы нельзя считать надёжными до проверки. Команда должна вернуть строку 23:07 в новую проверенную хронологию, сохранить обе исходные версии и их хэши, сменить доступы и токены, а затем провести полное интервью с Никитой в присутствии второго расследователя.
