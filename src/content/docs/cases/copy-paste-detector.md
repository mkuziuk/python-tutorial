...
<div class="case-meta">
  <p><strong>Миссия</strong> найти пары текстовых фрагментов, которые слишком похожи друг на друга.</p>
...
После анонимной записки редактор просматривает соседние материалы архива. В подборке коротких фрагментов появляется новая странность: несколько текстов повторяют одни и те же соседние фразы почти тем же порядком слов.

Вопрос дела: какие пары действительно похожи на копирование, а какие просто описывают одну тему похожими словами?
...
1  Отчет атриума / Заметка о теплице                0.45+  ...
2  Блог кружка / Дневник сенсорной лаборатории      0.30+  ...
```
...
- [Современный Python](../../field-guide/modern-python/) - Python 3.14+, виртуальная среда и зависимости.
