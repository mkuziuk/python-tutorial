...
<div class="case-meta">
  ...
  <p><strong>Результат</strong> таблица кандидатов и `artifacts/01-authorship.json`, который прочитает I-02.</p>
...
Перед началом создайте виртуальную среду — отдельную папку с Python и библиотеками только для этого расследования. Так зависимости проекта не смешаются с системным Python и другими проектами. Нужен Python 3.13 или новее; проверьте версию командой `py -3 --version` в Windows или `python3 --version` в macOS и Linux.
