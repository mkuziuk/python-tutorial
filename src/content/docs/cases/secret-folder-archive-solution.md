...
description: "Полный код четвертого дела: индексатор папки, SHA-256, JSON-манифест, дубли и изменения."
concepts:
  - pathlib
  - file traversal
  - hashlib
...
Эта страница нужна после того, как вы уже собрали `secret_folder_archive.py` по главе. Если открыть ее раньше, архивариус станет слишком разговорчивым.
...
Справочник: [pathlib](../../field-guide/pathlib/), [hashlib](../../field-guide/hashlib/), [JSON](../../field-guide/json/), [exceptions](../../field-guide/exceptions/), [dict](../../field-guide/dict/), [list](../../field-guide/list/), [Rich](../../field-guide/rich/).
