...
<div class="case-meta">
  <p><strong>Миссия</strong> проверить шесть учебных писем и отделить две ловушки от обычной переписки.</p>
...
Пока команда разбирает текстовые следы, в учебный почтовый ящик приходят новые письма: одно пугает блокировкой архива, другое обещает "отчет с камеры" после ночного сигнала. Всего в наборе шесть `.eml`: два выглядят как ловушки, четыре похожи на обычную рабочую переписку.

Все письма синтетические: используем только учебные домены и документационные IP-адреса.
