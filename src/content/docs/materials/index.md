...
Если во время работы нужно быстро вспомнить `list`, `dict`, `pathlib`, JSON или другой инструмент, возвращайтесь в [Справочник следователя](../field-guide/): ссылки на нужные страницы также есть в начале каждого дела.
...
- папка `data/` с синтетическими фрагментами;
...
- безопасные синтетические `.eml` в `data/`;
