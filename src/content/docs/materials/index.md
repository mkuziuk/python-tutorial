...
- стартовый скрипт доски расследования с комментариями-ориентирами;
...
Для дел в тетрадях Jupyter нужен Python 3.12 или 3.13. Локально распакуйте ZIP, откройте папку дела и выполните:
...
<div class="materials-panel">
  ...
  <p><strong>Данные:</strong> <a href="../datasets/titanic.csv" download><code>titanic.csv</code></a> · <a href="../datasets/titanic.csv.sha256">SHA-256</a> · тот же зафиксированный снимок Titanic; конвейер обработки без утечки включён в тетрадь, предыдущее дело не требуется на диске</p>
...
Готовые тетради лежат в `solution/` каждого проекта и связаны со страницами разбора. Не заменяйте ими тетрадь для самостоятельной работы до собственной попытки: ценность расследования — в выборе процедуры и письменном обосновании, а не только в выполненном коде.
