...
На этой странице собраны рабочие папки первой арки. В каждом архиве лежат только файлы ученика: README, данные, пустой стартовый скрипт, `requirements.txt` и пример формы вывода. Полные решения открываются отдельно в главах разбора.
