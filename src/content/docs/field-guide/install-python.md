...
`requirements.txt` ставит нужные библиотеки для текущего дела. В первой арке это в основном Rich: он делает терминальные таблицы читаемыми, а логика расследования остаётся на стандартной библиотеке Python.
