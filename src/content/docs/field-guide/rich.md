---
title: "Rich: читаемый терминальный отчёт"
...
Используйте Rich, когда отчёт должен быть читаемым: таблица результатов, список предупреждений, компактная сводка.
...
- Все расследования первой арки используют Rich только для финального отчёта.
