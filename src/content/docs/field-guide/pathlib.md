...
- [Расследование 04. Ночной сигнал архива](../../cases/secret-folder-archive/) - обходим папку и сохраняем относительные пути в индексе.
- [Расследование 05. Доска расследования](../../cases/investigation-system/) - сохраняем базу расследований в JSON.
