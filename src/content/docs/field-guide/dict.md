...
- [Дело 02. Детектор текстовых совпадений](../../cases/copy-paste-detector/) - индекс отчетов и счетчики совпадений.
- [Дело 04. Ночной сигнал архива](../../cases/secret-folder-archive/) - записи файлов, manifest и отчет об изменениях.
