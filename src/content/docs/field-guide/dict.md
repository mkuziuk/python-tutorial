...
- [Расследование 04. Ночной сигнал архива](../../cases/secret-folder-archive/) - записи файлов, проверенные отчёты и выводы индекса.
- [Расследование 05. Доска расследования](../../cases/investigation-system/) - подготовка JSON-представления объектов.
