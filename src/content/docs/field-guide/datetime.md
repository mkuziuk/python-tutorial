...
- [Расследование 04](../../cases/secret-folder-archive/) — переводим время изменения файлов в UTC.
- [Расследование 06](../../cases/final-verdict/) — загружаем ISO-время со смещением и строим проверяемую хронологию.
