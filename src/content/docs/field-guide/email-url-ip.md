...
description: "Стандартные модули для безопасного анализа писем, ссылок и сетевых адресов."
...
- [Дело 03. Фишинговое письмо или нет?](../../cases/phishing-email/) - достаем заголовки, ссылки и сетевые признаки из безопасных синтетических писем.
