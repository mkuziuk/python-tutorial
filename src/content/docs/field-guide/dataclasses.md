...
- [Расследование 05. Доска расследования](../../cases/investigation-system/) - `Evidence`, `Person`, `Hypothesis`, `EvidenceLink` и `Investigation` как объекты предметной области.
- [Расследование 06. Вердикт перед открытием](../../cases/final-verdict/) - неизменяемые факты, фабрики `from_dict()` и вычисляемый балл гипотезы.
