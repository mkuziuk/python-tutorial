...
export const homeStoryDetails: Record<string, HomeStoryDetail> = {
  ...
  'I-05': {
    ...
    tool: 'Классы, dataclass, композиция и сохранёние в JSON.',
  ...
  'I-06': {
    ...
    summary:
      'До открытия остаётся меньше двух часов. Результаты пяти дел нужно превратить в осторожный и объяснимый вердикт.',
  ...
  'II-03': {
    ...
    outcome: 'Доля правильных ответов скрывала цену ошибок и различия между группами.',
  ...
  'II-06': {
    ...
    summary:
      'В финале у каждого изображения есть источник, вариант и партия сканера. В разбиении поставщика связанные снимки оказываются по обе стороны границы.',
