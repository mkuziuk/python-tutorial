...
export const homeStoryDetails: Record<string, HomeStoryDetail> = {
  ...
  'I-04': {
    ...
    question: 'Совпадают ли входные отчёты с зафиксированными файлами и чем различаются хронологии?',
    tool: 'pathlib, SHA-256, относительные пути, difflib и JSON.',
    outcome: '04-evidence-index.json с хэшами, дублями и расхождением 22:53 / 23:07.',
    artifact: '04-evidence-index.json',
  ...
  'I-05': {
    ...
    summary:
      'Доска загружает реальные отчёты I-01–I-04 и сохраняет происхождение каждой созданной улики.',
    question: 'Как связать проверенные выводы с людьми и гипотезами без ручного пересказа?',
    tool: 'Классы, dataclass, композиция, проверка ID и отношения объектов.',
    outcome: '05-case-board.json с уликами, origin_finding_id и связями.',
    artifact: '05-case-board.json',
  ...
  'I-06': {
    ...
    summary:
      'Программа загрузит доску I-05, добавит новые утренние проверки и рассчитает итог для каждой гипотезы.',
    ...
    outcome: '06-verdict.json с хронологией, рейтингом, решением и планом действий.',
    artifact: '06-verdict.json',
