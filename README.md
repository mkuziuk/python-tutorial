...
- `projects/case-01/` … `projects/case-04/` — четыре проекта части I с данными, стартовыми файлами, решениями и тестами.
...
В публичный репозиторий должны попадать только оригинальные материалы из этого каталога. Локальные PDF-файлы из соседнего каталога `../private-assets/` не нужны для сборки и не должны коммититься.
